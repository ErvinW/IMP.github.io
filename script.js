...
let student1 = new Student("student1", "password1", "Jason", "class1", 4.0, 4.0, 4.0,4.0, false);
let json1 = JSON.stringify(student1)
localStorage.setItem(student1.username,json1)

let student2 = new Student("student2", "password2", "Damian", "class1", 3.0, 3.0, 3.0,3.0, false);
let json2 = JSON.stringify(student2)
localStorage.setItem(student2.username,json2)

let student3 = new Student("student3", "password3", "Tim", "class1", 4.0, 4.0, 3.8,3.9, false);
let json3 = JSON.stringify(student3)
localStorage.setItem(student3.username,json3)

let student4 = new Student("student4", "password4", "Bruce", "class1", 4.0, 2.5, 2.7,3.1, false);
let json4 = JSON.stringify(student4)
localStorage.setItem(student4.username,json4)

let senior1 = new Student("Senior1", "SenPW1", "Alfred", "SenClass1", 4, 4, 4, 4, false);
